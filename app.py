...
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show analysis"):
    	...
    	# 	st.subheader('Monthly Timeline')
    	# 	fig4, ax4 = plt.subplots()
	    # 	ax4.plot(monthly_timeline['time'], monthly_timeline['messages'])
	    # 	plt.xticks(rotation='vertical')
	    # 	st.pyplot(fig4)
	    ...
	    # 	st.subheader('Daily Timeline')
	    # 	fig5, ax5 = plt.subplots()
	    # 	ax5.plot(daily_timeline['dt'], daily_timeline['messages'])
	    # 	plt.xticks(rotation='vertical')
	    # 	st.pyplot(fig5)
    	...
    	# with col1:
    	# 	fig6, ax6 = plt.subplots()
	    # 	ax6.bar(day_timeline['index'], day_timeline['day_name'])
	    # 	plt.xticks(rotation='vertical')
	    # 	st.pyplot(fig6)
		# with col2:
	    # 	fig7, ax7 = plt.subplots()
	    # 	ax7.bar(monthly_timeline['month'], monthly_timeline['messages'])
	    # 	plt.xticks(rotation='vertical')
	    # 	st.pyplot(fig7)
